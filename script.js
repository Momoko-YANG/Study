...
// 将这些函数替换你现有的密码相关JavaScript代码

// 设置你的密码（请改为你想要的密码）
const CORRECT_PASSWORD = "myresume2024";

// 简历文件路径
const RESUME_PATH = "./static/files/2025年度スキルアップシート_楊夢圓.xls";
const RESUME_FILENAME = "我的简历.xls";
...
- 使用本地AI: ${!aiChatbotConfig.apiConfig.useExternalAPI ? '✅ 是' : '❌ 否'}
